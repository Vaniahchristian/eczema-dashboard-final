...
export default function SupportAssistant() {
  ...
  return (
    <div className="flex flex-col h-[600px]">
      ...
      <div className="flex-1 overflow-y-auto mb-0 bg-muted/30 rounded-lg p-4">
        <AnimatePresence>
          {messages.map((message) => (
            <motion.div
              ...
              className={`flex mb-0 ${message.sender === "user" ? "justify-end" : "justify-start"}`}
            >
      ...
      <div className="mb-0">
        <p className="text-sm font-medium mb-0">Quick Questions:</p>
