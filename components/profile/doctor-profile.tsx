        ...
        <div className="mt-12 space-y-6">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400">
              {profileData.email} • License No: {profileData.licenseNumber}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-slate-500 dark:text-slate-400">{profileData.clinicAddress}</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-slate-500 dark:text-slate-400">{profileData.consultationHours}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400">{profileData.about}</p>
          </div>

          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-slate-900 dark:text-white mb-2">Education</h3>
            ...
            <div>
              <h3 className="font-medium text-slate-900 dark:text-white mb-2">Certifications</h3>
              <div className="space-y-2">
